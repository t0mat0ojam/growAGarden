//
//  VolunteerView 2.swift
//  growAGarden
//
//  Created by Tamon Sasaki on 2025/09/03.
//
...
struct VolunteerView: View {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            ForEach(mockOpportunities.filter { opportunity in
    ...
    // Mock data
    private var mockOpportunities: [VolunteerOpportunity] {
        [
            ...
            VolunteerOpportunity(
                ...
                description: "Sort and package donated food items for distribution to families in need.",
                category: .community,
                duration: "2 hours",
                spotsAvailable: 8
            ),
            VolunteerOpportunity(
                title: "Reading Tutor",
                organization: "Elementary School District",
                date: "Weekdays, 3:30 PM",
                location: "Lincoln Elementary School",
                description: "Help elementary students improve their reading skills through one-on-one tutoring.",
                category: .education,
                duration: "1 hour",
                spotsAvailable: 5
            ),
...
struct FeaturedOpportunityCard: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Join us for our monthly tree planting event! Help make our city greener while meeting like-minded volunteers.")
                .font(.system(size: 14))
                .foregroundColor(.secondary)
                .lineLimit(nil)
